  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: (_isTestFinished || _hasPreviousResult) ? Icon(Icons.refresh) : Icon(Icons.done_all),
            onPressed: (_isTestFinished || _hasPreviousResult) ? _restartTest : _finishTest,
            tooltip: (_isTestFinished || _hasPreviousResult) ? 'Làm lại' : 'Nộp bài',
          ),
        ],
      ),
      body: Column(
